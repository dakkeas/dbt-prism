...
{% macro md_scorecard_v2(primaryicdgroup_list, top_n_provider, top_n_physicians, more_than_n_patients) %}
...
FROM physician_engine
    ...
    WHERE providername IN (
        SELECT providername FROM (
            ...
            FROM {{ref('vetting_provider_engine')}}
