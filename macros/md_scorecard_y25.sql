{% macro md_scorecard_y25(primaryicdgroup_list, top_n_provider, top_n_physicians, more_than_n_patients, px_engine_model='px_engine_y25', icd_column='combined_starting_primaryicdgroup') %}
