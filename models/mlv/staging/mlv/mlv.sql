...
merged_table AS (
    SELECT
        ...
        COALESCE(fc.total_availment_cost, 0) AS total_availment_cost,
        COALESCE(fc.total_availment_count, 0) AS total_availment_count,
        fc.earliest_availment_date,
        fc.latest_availment_date,
